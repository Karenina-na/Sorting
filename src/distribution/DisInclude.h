...
#ifndef SORTING_ALGORITHM_INTERFACE_FRAMEWORK_DISINCLUDE_H
#define SORTING_ALGORITHM_INTERFACE_FRAMEWORK_DISINCLUDE_H
...
#endif //SORTING_ALGORITHM_INTERFACE_FRAMEWORK_DISINCLUDE_H